    ...
    <div class="container mx-auto p-6">
        <div class="overflow-x-auto bg-white rounded-lg shadow-lg">
            <table class="min-w-full text-left text-sm text-gray-800 text-center">
                ...
                <tbody>
                    <?php foreach ($result as $admins): ?>
                        <tr class="border-b hover:bg-gray-50">
                            <td class="px-4 py-2"><?= $admins['f_id'] ?></td>
                            <td class="px-4 py-2"><?= $admins['f_username'] ?></td>
                            <td class="px-4 py-2"><?= $admins['f_email'] ?></td>
                            <td class="px-4 py-2"><?= $admins['f_password'] ?></td>
                            <td class="px-4 py-2">
                            	<a href="edit.php?id_admin=<?= $admins['f_id'] ?>" class="bg-[#82EA4A] p-1 hover:bg-opacity-75 rounded-md mr-5">
                            		<i class="fas fa-pen-square mr-2 mb-[1rem]"></i> Edit Undangan
                            	</a>
                            	<a href="" class="bg-[#E21313] p-1 hover:bg-opacity-75 text-white rounded-md">
                            		<i class="fas fa-trash mr-2"></i> Hapus Undangan
                            	</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
