            ...
            <?php foreach ($result as $acara): ?>
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative hover:scale-[1.05] transition ease-in-out">
                    <div class="absolute right-4 top-4 flex flex-col">
                        <button class="bg-green-500 opacity-25 text-sm transition ease-in hover:opacity-100 text-white px-2 py-2 rounded-lg mb-2 shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 z-[999]" onclick="window.location.href='edit.php?id_acara=<?= $acara['f_id'] ?>'">
                         <i class="fas fa-pen-square mr-2">
                         </i>
                         Edit Acara
                        </button>
                        <button class="bg-red-500 opacity-25 text-sm transition ease-in hover:opacity-100 text-white px-2 py-2 rounded-lg shadow hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 z-[999]" onclick="ConfirmDelete(<?=$acara['f_id'] ?>)">
