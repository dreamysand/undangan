...
<body class="bg-[#DBE5FF] font-roboto min-h-screen text-gray-800">
    ...
    <nav class="bg-[#0A2C82] shadow-lg">
        <div class="container mx-auto flex justify-between items-center p-4 relative">
            ...
            <!-- Judul Navbar -->
            <h1 class="text-2xl font-bold mx-auto text-white">Tambah Acara</h1>
        </div>
    </nav>
    ...
    <div class="container mx-auto p-6">
        ...
        <form action="update_acara.php" method="POST" enctype="multipart/form-data" class="bg-white text-gray-800 p-6 rounded-lg shadow-lg mt-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="event_location" name="lokasi" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan lokasi acara">
            </div>
            <div class="mb-4">
